    ...
    <>
      ...
      <section className="flex justify-center overflow-hidden relative">
        <div className="flex flex-col items-center shadow-xl my-10 p-10 rounded-lg border-b-4 border-orange-500">
          <span className="text-lg font-bold text-blue-900 pb-1">
            ورود به حساب کاربری
          </span>
          ...
          <form action="#" className="w-full">
            ...
            <div className="login-form__password recaptcha-parent my-3 ">
              <ReCAPTCHA
            ...
            >
              ...
              <span className="mx-auto text-lg text-blue-900 font-bold">
                ورود
              </span>
            </Button>
            <div className="flex justify-between mt-3">
              <label className="flex items-center">
                ...
                <span className="text-gray-500">مرا به خاطر داشته باش</span>
              </label>
